		...
		<footer>
			...
			<div className="h-[130px] bg-cbd-brand-5 w-full fcc">
				...
				>
					...
					>
						<Link href={t("footerInfo.beian.url")} target="_blank">
							{t("footerLabel.beian")}：{t("footerInfo.beian.no")}
						</Link>
						<span>
							{" "}
							{t("footerLabel.addr")}：{t("footerInfo.addr")}
						</span>
						<span>
							{" "}
							{t("footerLabel.visits")}：{t("footerInfo.visits")}
						</span>
					</motion.div>
					<motion.div
					...
					>
						<span>
							{t("footerLabel.website")}：{t("footerInfo.website")}
						</span>
						<span className="mx-[10px]">
							{" "}
							{t("footerLabel.franchiseHotline")}：
							{t("footerInfo.franchiseHotline")}
						</span>
						<span className="mr-[10px]">
							{t("footerLabel.customerServiceHotline")}：
							{t("footerInfo.customerServiceHotline")}
						</span>
						<Link href={t("footerInfo.support.url")} target="_blank">
