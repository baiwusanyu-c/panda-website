      ...
      <div className='fsc'>
        {
          resolveDate ? <>
            <div className='fcc flex-col'>
              <p className='leading-[58px] text-[48px] text-cbd-gray-5 font-normal'>{resolveDate.day}</p>
              <p className='leading-[14px] text-[14px] text-cbd-gray-5 font-normal'>{resolveDate.date}</p>
            </div>
        ...
        <div className='fss flex-col'>
          {
            data.subTitle ? <>
                <p className={`${resolveDate ? 'px-[15px]' : 'px-[30px]'} text-[18px] text-cbd-brand-5`}>{data.title}</p>
                <p className={`${resolveDate ? 'px-[15px]' : 'px-[30px]'} text-[14px] leading-[20px] text-cbd-gray-5 overflow-hidden text-ellipsis`}>{data.subTitle}</p>
              </> :
              <p className={`${resolveDate ? 'px-[15px]' : 'px-[30px]'} text-[18px]`}>{data.title}</p>
          }
        </div>
      </div>
