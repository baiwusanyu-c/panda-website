            ...
            <motion.div
                ...
                <div className='bg-cbd-brand-1 h-[260px] fsc w-full mt-[35px] py-[40px]'>
                    ...
                    grid grid-cols-2 gap-x-60 text-cbd-gray-6 fsc leading-[40px]`}>
                        ...
                        <div className='fsc'><MailFilled className='!text-cbd-brand-5 text-[23px] mr-[15px]'/>{ data.headquarter.email }</div>
                        <div className='fsc'><WarningFilled className='!text-cbd-brand-5 text-[23px] mr-[15px]'/>{ data.headquarter.networkSecurity }</div>
                        <div className='fsc'><PhoneFilled className='!text-cbd-brand-5 text-[23px] mr-[15px]'/>{ data.headquarter.franchiseHotline }</div>
                        <div className='fsc'><HeartFilled className='!text-cbd-brand-5 text-[23px] mr-[15px]'/>{ data.headquarter.reportingMobile }</div>
