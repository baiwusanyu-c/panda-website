...
export default function HomePage(props: HomePageProps) {
	const { headquarter, operationCenters, news } = props.data;
	...
	const shopContactList = useMemo(() => {
		return ["wechat", "weibo", "tiktok", "xhs"].map((item) => {
			return {
				name: tHome(`${item}`),
				link: tHome(`${item}Link`),
			};
		});
	}, [tHome]);
	return (
		<div className="chapanda-tea-home overflow-x-hidden bg-cbd-white w-full">
			...
			<div className="w-full h-[800px] bg-cbd-brand-5 pr overflow-hidden">
				<div className="w-[70%] pa top-[170px] left-[12%] z-[1]">
					<p className="text-[60px] leading-[1.2] text-white">
						{tHome("name")}
					</p>
					<p className="text-[60px] leading-[1.2] text-white">
						{tHome("exceeds")}
						<span className="text-cbd-yellow-2">8000+</span>
					</p>
					<div className="flex mt-[50px]">
						{shopContactList.map((item, index) => {
							return (
								<a
									key={item.name}
									className="fsc flex-col mr-[30px]"
									href={item.link}
									target="_blank"
									rel="noreferrer"
								>
									<Image
										...
										height={132}
									/>
									<p className="mt-[8px] text-cbd-white text-[16px] leading-[28px]">
										{item.name}
									</p>
								</a>
							);
				...
				<div className="bubble right-[50px] top-[100px] pa pt-[100px] w-[100px] bg-[#1256e9] rounded-[100%]"></div>

				<div className="bubble right-[60%] bottom-[100px] pa pt-[80px] w-[80px] bg-[#1256e9] rounded-[100%]"></div>

				<div className="bubble right-[50px] bottom-[100px] pa pt-[400px] w-[400px] border-solid border-1 border-cbd-green-4 rounded-[100%]"></div>
				<div className="bubble right-[300px] -bottom-[200px] pa pt-[400px] w-[400px]  bg-[#0946cc] rounded-[100%]"></div>
				<Image
					aria-hidden
				...
				<div className="bubble -left-[100px] -bottom-[100px] pa pt-[260px] w-[260px] border-solid border-1 border-cbd-green-4 rounded-[100%]"></div>
				<div className="bubble left-[0] -top-[30%] pa pt-[20%] w-[20%] bg-[#0946cc] rounded-[100%]"></div>
			</div>
			<PandaTeaIntroduction
				intro={tAbout(`introduce`)}
			...
			<video
				...
				loop
				controls
				className="mx-auto my-0 max-w-[1500px] min-w-[1200px] w-[94%]"
			>
				<source
					src="https://i02.appmifile.com/37_operatorx_operatorx_xm/21/08/2024/cb3e152f01ffc96f512693bbc46aa232.mp4"
					type="video/mp4"
				/>
			</video>
			<motion.div
						...
						>
							...
							<div className=" h-full fcs flex-col ml-[30px]">
								...
								<p
									className={
										lang === "zh"
											? "text-[22px] text-cbd-gray-25"
											: "text-[32px] text-cbd-white"
									}
								>
									Advantage
								</p>
				...
				<div className="mx-auto mb-[60px] max-w-[1500px] min-w-[1200px] w-[94%] mt-[120px]">
					...
					<Swiper
						...
						pagination={{
							...
							bulletActiveClass:
								"news-bullet-active swiper-pagination-bullet-active",
						...
						<div className=" h-[260px] fsc w-full mt-[35px]">
							...
							>
								...
								<div className="fsc">
									...
									{headquarter.networkSecurity}
								</div>
								<div className="fsc">
									<PhoneFilled className="!text-cbd-brand-5 text-[23px] mr-[15px]" />
									{headquarter.franchiseHotline}
								</div>
								<div className="fsc">
									<HeartFilled className="!text-cbd-brand-5 text-[23px] mr-[15px]" />
									{headquarter.reportingMobile}
								</div>
								<div className="fsc">
									<PhoneFilled className="!text-cbd-brand-5 text-[23px] mr-[15px]" />
									{headquarter.customerServiceHotline}
								</div>
							</div>
						</div>
