		...
		>
			<div className="mx-auto my-0 max-w-[1500px] min-w-[1200px] w-[94%] fbc">
				...
				<motion.div className="pr w-[40%] h-[268px]">
					<motion.div
						className="left-[33%] bottom-0 pa pt-[35%] w-[35%] bg-[#ebf2f8] rounded-[100%] bg-no-repeat "
						style={{
							backgroundImage: `url(/t8.webp)`,
					...
					>
						<span
							style={{ fontFamily: "var(--oppp-sans)" }}
							className="w-full h-auto overflow-hidden pa left-0 top-[45%] text-center text-[16px] text-cbd-gray-6 font-[500]"
						>
							{t("babble2")}
						</span>
					</motion.div>
					...
					>
						<span
							style={{ fontFamily: "var(--oppp-sans)" }}
							className="w-full h-auto overflow-hidden pa left-0 top-[40%] text-center text-[16px] text-cbd-gray-6 font-[500]"
						>
							{t("babble4")}
						</span>
					</motion.div>
					<motion.div className="bubble left-[25%] top-[40%] pa pt-[5%] w-[5%] bg-[#ebf2f8] rounded-[100%]"></motion.div>
					<motion.div className="bubble right-[2%] top-[55%] pa pt-[3%] w-[3%] bg-cbd-yellow-2 rounded-[100%]"></motion.div>
				</motion.div>
			</div>
		</motion.div>
	);
